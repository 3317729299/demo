...
public class MybatisPlusConfig {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/mybatisplus?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=CTT");
        ...
        strategyConfig.setInclude("sys_role");//对哪张表生成
        ...
        strategyConfig.setTablePrefix("sys_");//生成实体时去掉表前缀
